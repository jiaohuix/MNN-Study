...
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO,  "MoeChat", __VA_ARGS__)
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR, "MoeChat", __VA_ARGS__)
...
Java_com_moechat_LlmBridge_initNative(JNIEnv* env, jobject /*thiz*/, jstring jConfigPath) {
...
Java_com_moechat_LlmBridge_resetNative(JNIEnv* /*env*/, jobject /*thiz*/, jlong ptr) {
...
JNIEXPORT void JNICALL
Java_com_moechat_LlmBridge_stopNative(JNIEnv* /*env*/, jobject /*thiz*/, jlong ptr) {
    auto* session = asSession(ptr);
    if (session) {
...
JNIEXPORT void JNICALL
Java_com_moechat_LlmBridge_releaseNative(JNIEnv* /*env*/, jobject /*thiz*/, jlong ptr) {
    auto* session = asSession(ptr);
    delete session;
}

JNIEXPORT jstring JNICALL
Java_com_moechat_LlmBridge_submitNative(JNIEnv* env, jobject /*thiz*/,
